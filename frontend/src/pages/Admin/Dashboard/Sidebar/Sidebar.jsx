...
const Sidebar = () => {
  return (
    <div className="-translate-y-10 flex h-screen fixed mt-10 border-r-2 border-[#0044cc]">
      <aside className="text-white w-64 flex-shrink-0">
        <ul className="py-4">
          <li className="text-lg bg-gradient-to-b from-blue-500 to-cyan-400 rounded-full -translate-x-6">
            <Link
          ...
          <li className="text-lg -translate-x-6 hover:bg-gradient-to-b from-blue-500 to-cyan-400 rounded-full">
